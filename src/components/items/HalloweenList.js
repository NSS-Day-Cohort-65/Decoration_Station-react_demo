...
export const HalloweenItems = ({ }) => {
  const [halloween, setHalloween] = useState([]) // returns an array: [stateVariable, setStatefunction] takes one argument: the initial value of the state variable
